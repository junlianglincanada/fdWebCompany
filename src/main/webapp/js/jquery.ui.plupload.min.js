			...
			'<div class="ui-widget-content plupload_container">' +
				'<div class="ui-state-default ui-widget-header plupload_header">' +
					'<div class="plupload_header_content">' +
						...
						'<div class="plupload_header_title">' + _("请选择上传图片") + '</div>' +
						'<div class="plupload_header_text">' + _("添加图片到上传区，之后点击开始上传按钮") + '</div>' +
				...
				'<div class="plupload_content">' +
					'<div class="plupload_droptext">' + _("请将图片拖至此处") + '</div>' +
				...
				'<tr>' +
					'<td class="plupload_cell plupload_file_name">' +
						'<div class="plupload_buttons"><!-- Visible -->' +
							'<a class="plupload_button plupload_add">' + _("新增图片") + '</a>&nbsp;' +
...
$.widget("ui.plupload", {
	...
	_create: function() {
		...
		// buttons
		this.browse_button = $('#'+this.options.browse_button).attr('id', id + '_browse');
