...
$(function(){
	$("#btn_reset").click(function(){
		...
		params={};
		$(".text_ts").remove();
		$("#diningCompanyName").val("从收货商中选择单位");
		$("input:text").val("");
		$("input[name='radio_a'][value=62001]").attr("checked",true);
		$("input[name='radio_b'][value=63001]").attr("checked",true);
		$("input[name='checkbox_c']").attr("checked",false);
	});
	$("#btn_save").click(function(){
		...
		$.ajax({
			url:"../meal/groupMeal/createGroupMeal",
			type:"post",
...
<div class="main_box">
     <div class="main_con">
          <h3 class="process_title"><span>当前位置: </span><a href="meals.meals">团膳外卖登记</a> > <a href="javascript:void(0)">新增团膳外卖登记</a></h3>
