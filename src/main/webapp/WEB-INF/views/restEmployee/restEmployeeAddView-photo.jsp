...
<div class="main_box">
     <div class="main_con">
          ...
          <div class="info_tab">
               <a href="../findView/restEmployee.restEmployeeAddView">基本信息</a>
               <a href="../findView/restEmployee.restEmployeeAddView-photo?id=<%=id%>" class="default">证件信息</a>
          </div>
           <form id="uploadForm" action="../restaurant/comEmployee/createComEmpLicence" method="post" enctype="multipart/form-data">
          <div class="info_box"> 
