...
<div class="main_box">
     <div class="main_con">
          <h3 class="process_title"><span>当前位置: </span><a href="../findView/restEmployee.restEmployeeView">从业人员</a> > <a href="#">查看从业人员</a> </h3>
          <div class="info_tab">
               <a href="../findView/restEmployee.restEmployeeDetailView?id=<%=id %>">基本信息</a>
               <a href="../findView/restEmployee.restEmployeeDetailView-photo?id=<%=id %>" class="default">证件信息</a>
          </div>
          <div class="info_box">
                  ...
                  <tr>
                       ...
                       <td >
                           <div class="photo_report" style="margin:0;display:none;" id="photo_report">
                              <div class="licen_img">
                                   <div id="pathFile" rel="img"><img src=""  id="filePath"></img></div>
                              </div>
                          </div>
                       </td>
                  </tr>
                  ...
                  <tr>
                       ...
                       <td colspan="3">
                           <div class="photo_report" style="margin:0;display:none;" id="photo_report1">
                              <div class="licen_img">
                                   <div id="imgTraining" rel="img"><img src="" id="trainingImg"></img></div>
                              </div>
                          </div>
                       </td>
                  </tr>
					...
					for(var i=0;i<licence.length;i++){
						if(licence[i].licenceType==26001){
							...
							if(filePath!=""){
								...
								$("#pathFile").find("a").attr("href","<%=fdWebFileURL%>"+filePath);
							}
						}
						if(licence[i].licenceType==26002){
							...
							if(filePath!=""){
								...
								$("#imgTraining").find("a").attr("href","<%=fdWebFileURL%>"+filePath);
							}
						}
				}
