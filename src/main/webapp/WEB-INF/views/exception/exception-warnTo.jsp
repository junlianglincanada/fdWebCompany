...
<div class="main_box">
     <div class="main_con">
         ...
         <div class="info_tab">
               <a href="exception.exception-warn" >健康证预警</a>
               <a href="exception.exception-warnTo" class="default">培训证预警</a>
          </div>
          <div class="table_box">
               <table class="table_list">
                    <thead>
                       <tr>
                           ...
                           <th style="min-width: 150px">培训证号</th>
...
function search(pageNum){
	...
	$.ajax({
		url:"../exception/searchWarnPerson/"+pageNum+"/"+pageSize,
		type:"post",
		dataType:"json",
		headers: { 
