...
function sendMessage(){
	...
	if(phone=="" || phone==null){
		...
		$("span.gray").text("手机号码不能为空！");
		return;
	}
	if(!isMobilephone(phone)){
		$("span.gray").addClass("ina_red");
		$("span.gray").text("请输入正确手机号码！");
		return;
    }
	params.phone=phone;
...
$(function(){
	...
	$(".btn_save").click(function(){
		...
		params.code=code;
		$.ajax({
    		url: "../security/systemUser/changedPhone",
    		type:"post",
    		dataType:'json',
    		data:params,
    		success:function(result){
...
<div class="ifr_box">
     <table class="info_mation">
            <tr>
                 <td class="td_lf"><em class="star">*</em>用户密码</td>
                 <td><input type="password" class="input_code" placeholder="请输入用户密码" name="pwd" value="" id="password"/></td>
            </tr>
            <tr>
                 <td class="td_lf"><em class="star">*</em>新手机号码</td>
                 <td><input type="text" class="input_code" placeholder="请输入新手机号码" name="mobile" value="" id="phone"/></td>
            </tr>
            <tr>
