...
$(function(){
	...
	$(".btn_save").click(function(){
		...
		$.ajax({
			url:"../retentionSample/createSample",
			type:"post",
...
<div class="main_box">
     <div class="main_con">
          <h3 class="process_title"><span>当前位置: </span><a href="sample.samples">留样登记</a> > <a href="javascript:void(0)">新增留样登记</a></h3>
          <h4 class="per_title"><span>基本信息</span></h4>
          <div class="per_box">
               <table class="info_mation" style="width:auto;" id="indexTable">
                   <tr>
                       <td class="td_lf"><em class="star">*</em>留样时间</td>
                   ...
                   <tr id="hide2" style="display:none">
                    <td class="td_lf" ><span id="way_text"></span></td>
          ...
          <div class="per_box">
               <table class="info_mation" style="width:auto;" id="detailTable">
                   <tr>
                       ...
                       <td>
                           <div class="sele_box">
                                <input type="text" class="input_sele" value="" id="category1" maxlength="20">
                                <a href="javascript:void(0)" class="btn_sele" rel="popup" link="sample.iframe-category?id=category1" title="选择产出品">从产出品中选择</a>
                           </div>
                       </td> 
