...
function search(pageNum){
	...
	$("#loading").show();
	$.ajax({
		url:"../statistics/inputBatch/getStatisticOfIBDBySupplier/"+pageNum+"/"+pageSize,
		type:"post",
			...
			if(result.status==0){
				...
				if(resultList==null||resultList.length==0){
					...
					for(var i=0;i<resultList.length;i++){
						...
						$("#companyName").text($("#supplierName").val().trim());
...
$(function(){
	...
	$("#main_box").hide();
	$("#can").load("../findView/datastatis.replenish.init");
	//点击上一页查询
	...
	$("#supplierName").focus(function(){
		...
		$.ajax({
			...
			dataType:'json',
			data:JSON.stringify(supplierParams),
	...
	$(".btn_query").click(function(){
		var supplierId=isnull($("#supplierId").text());
	...
	$(".btn_export").click(function(){
		...
		$.ajax({
			url: "../statistics/inputBatch/exportStatisticOfIBDBySupplier",
			type:"post",
		    headers: { 
		        'Accept': 'application/json',
		        'Content-Type': 'application/json' 
...
<div class="main_box">
     <div class="main_con">
          <h3 class="process_title"><span>当前位置: </span><a href="#">进货对账</a>
              <div class="btn_opera"> 
          ...
          <div class="query">
               ...
               <span><em>供应商名称：</em><input type="text" class="input_code" value="" id="supplierName"/></span><span id="supplierId" style="display:none"></span>
          ...
          <div class="table_box" id="main_box">
               <table class="table_list">
                 ...
                 <p>共<span id="totalMat">0</span>种采购品</p>
                 <p class="paging_box">
