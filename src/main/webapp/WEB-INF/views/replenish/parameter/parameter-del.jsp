...
$(function(){
	...
	$(".btn_blue").click(function(){
		...
		$("#loading").show();
		$.ajax({
			url:"../inputManage/inputBatch/deleteImportFileList/"+id,
			type:"post",
			dataType:"json",
			headers: { 
		    ...
		    console.log(result);
		     // alert("删除成功");
		     window.parent.location.href="../findView/replenish.parameter.batch?pageNum="+pageNum+"&importDate="+importDate+"";
