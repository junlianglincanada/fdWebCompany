...
<div class="main_box">
     <div class="main_con">
          <h3 class="process_title"><span>当前位置: </span><a href="../findView/replenish.purchased.purchased"">采购品</a> > <a href="#">新增采购品</a> > <a id="name1"></a> </h3>
          <div class="info_tab">
               <a href="../findView/replenish.purchased.purchased-add?id=<%=id %>">基本信息</a>
               <a href="../findView/replenish.purchased.purchased-add-photo?id=<%=id %>" class="default">图片信息</a>
          </div>
          <div class="info_box">
