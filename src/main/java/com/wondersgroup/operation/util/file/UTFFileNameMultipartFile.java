...
public class UTFFileNameMultipartFile implements MultipartFile, Serializable {

    protected static final Log logger = LogFactory.getLog(UTFFileNameMultipartFile.class);
     ...
     */
    public UTFFileNameMultipartFile(FileItem fileItem) {
