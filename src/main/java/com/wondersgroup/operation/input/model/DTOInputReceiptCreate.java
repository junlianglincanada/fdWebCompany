...
public class DTOInputReceiptCreate {
	...
	public static InputReceipt toEntitie(DTOInputReceiptCreate dto, Integer companyId,InputReceiptService inputReceiptService) {
